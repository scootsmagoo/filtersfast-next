  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        {/* Call to Action */}
        <Card className="p-8 mb-12 bg-gradient-to-r from-blue-50 to-indigo-50 border-blue-200">
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-4 mb-8">
            ...
            <Card className="p-6 text-center">
              ...
              <h3 className="font-semibold text-gray-900 mb-2">Step 1: Login</h3>
            ...
            <Card className="p-6 text-center">
              ...
              <h3 className="font-semibold text-gray-900 mb-2">Step 2: Select Order</h3>
              <p className="text-sm text-gray-600">
            ...
            <Card className="p-6 text-center">
              ...
              <h3 className="font-semibold text-gray-900 mb-2">Step 3: Request</h3>
              <p className="text-sm text-gray-600">
            ...
            <Card className="p-6 text-center">
              ...
              <h3 className="font-semibold text-gray-900 mb-2">Step 4: Ship</h3>
              <p className="text-sm text-gray-600">
            ...
            <Card className="p-6 text-center">
              ...
              <h3 className="font-semibold text-gray-900 mb-2">Step 5: Refund</h3>
              <p className="text-sm text-gray-600">
                Get your money back
              </p>
            </Card>
          ...
          <div className="space-y-4">
            ...
            <Card className="p-6">
              ...
              <p className="text-gray-700">
                ...
                <a href="mailto:support@filtersfast.com" className="text-blue-600 hover:underline">
            ...
            <Card className="p-6">
              ...
              <p className="text-gray-700">
                ...
                <Link href="/account/returns" className="text-blue-600 hover:underline">
                  Returns
                </Link>
