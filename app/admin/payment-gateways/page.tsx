...
CYBERSOURCE_API_SECRET=...`}
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-1 text-sm" aria-labelledby="step-3">
                ...
                <li><strong>Authorize.Net:</strong> Secondary backup gateway for automatic failover</li>
                <li><strong>CyberSource:</strong> Legacy parity failover for extended redundancy</li>
              </ul>
            </div>
          </div>
        </Card>
