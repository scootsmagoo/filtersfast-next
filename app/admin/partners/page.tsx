    ...
    <>
      ...
      <div className="container-custom py-12">
        <div className="mb-8">
          <div className="flex items-center justify-between mb-4">
            <div>
              <h1 id="main-content" className="text-3xl font-bold text-gray-900 mb-2 flex items-center gap-3" tabIndex={-1}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        ...
        <Card className="p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-600 mb-1">Charity Partners</p>
              <p className="text-2xl font-bold text-gray-900">{charityPartners.length}</p>
            </div>
        ...
        <Card className="p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900">{corporatePartners.length}</p>
            </div>
                ...
                {partner.logo && (
                  <div className="flex-shrink-0">
                    <img
                      src={partner.logo}
                      alt={partner.name}
                      className="w-20 h-20 object-contain rounded-lg bg-white border border-gray-200 p-2"
                    />
                  </div>
                )}
                  ...
                  <div className="flex items-start justify-between mb-3">
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-2 flex-wrap">
                        ...
                        <span className={`px-2 py-1 text-xs font-medium rounded ${getPartnerTypeBadgeColor(partner.type)}`}>
                  ...
                  {partner.discountCode && (
                    <div className="bg-green-50 border border-green-200 rounded-lg p-3 mb-3">
                      <div className="flex items-center gap-2 text-sm">
                        ...
                        <code className="px-2 py-1 bg-green-100 text-green-900 rounded font-mono text-xs">
                          {partner.discountCode}
                        </code>
                        {partner.discountDescription && (
                          <span className="text-green-700">- {partner.discountDescription}</span>
                        )}
                      </div>
                    </div>
                  )}
                  ...
                  {expandedPartner === partner.id && (
                    <div className="mt-4 pt-4 border-t border-gray-200 space-y-3">
                      ...
                      {partner.missionStatement && (
                        <div>
                          <h4 className="font-medium text-gray-900 mb-1">Mission Statement</h4>
                          <p className="text-sm text-gray-600 italic">{partner.missionStatement}</p>
                        </div>
                      )}
                      <div>
                        <h4 className="font-medium text-gray-900 mb-1">Content Blocks</h4>
                      ...
                      {partner.metaTitle && (
                        <div>
                          ...
                          <p className="text-sm text-gray-600">{partner.metaTitle}</p>
                        </div>
                      )}
                    </div>
                  )}
