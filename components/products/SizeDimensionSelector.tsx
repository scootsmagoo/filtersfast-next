...
export default function SizeDimensionSelector({
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h2 className="text-2xl font-bold text-brand-gray-900 mb-2 flex items-center gap-2">
          <Ruler className="w-6 h-6 text-brand-orange" aria-hidden="true" />
          Find Your Filter Size
        </h2>
        <p className="text-brand-gray-600" id="size-selector-description">
      ...
      <Card className="p-6">
        <h3 className="text-lg font-semibold text-brand-gray-900 mb-4" id="custom-dimensions-heading">
        ...
        >
          ...
          <div>
            ...
            <input
              ...
              placeholder="e.g., 16"
              className="w-full px-4 py-2 border border-brand-gray-300 rounded-lg focus:ring-2 focus:ring-brand-orange focus:border-transparent outline-none"
        ...
        {/* Tip */}
        <div className="mt-4 p-3 bg-blue-50 border border-blue-200 rounded-lg" id="dimension-help">
      ...
      {commonSizes.length > 0 && (
        <Card className="p-6">
          <h3 className="text-lg font-semibold text-brand-gray-900 mb-4" id="popular-sizes-heading">
            Popular Sizes
          </h3>
          <div 
                ...
                className={`
                  ...
                  ${
                    selectedCommonSize === size.label
                      ...
                      : 'border-brand-gray-300 text-brand-gray-700 hover:border-brand-orange hover:bg-brand-orange/5'
                  }
                `}
      ...
      {/* Measurement Guide */}
      <Card className="p-6 bg-gradient-to-br from-orange-50 to-blue-50 border-2 border-brand-orange/20">
        <h3 className="text-lg font-semibold text-brand-gray-900 mb-3 flex items-center gap-2">
          <Ruler className="w-5 h-5 text-brand-orange" aria-hidden="true" />
          How to Measure Your Filter
        </h3>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div>
            <div className="font-semibold text-brand-gray-900 mb-1">1. Check Existing Filter</div>
            <p className="text-sm text-brand-gray-700">
              The size is usually printed on the cardboard frame (e.g., 16x20x1)
            </p>
          </div>
          <div>
            <div className="font-semibold text-brand-gray-900 mb-1">2. Measure if Needed</div>
            <p className="text-sm text-brand-gray-700">
              Use a tape measure: Height × Width × Depth in inches
            </p>
          </div>
          <div>
            <div className="font-semibold text-brand-gray-900 mb-1">3. Round to Nearest</div>
            <p className="text-sm text-brand-gray-700">
